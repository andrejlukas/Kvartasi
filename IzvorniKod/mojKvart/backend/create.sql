...
create table kupac (kupac_id integer not null, kupac_ime varchar(20) not null, kupac_prezime varchar(20) not null, kupac_adresa varchar(50) not null, kupac_email varchar(50) not null unique, role varchar(50), kupac_sifra varchar(200) not null, primary key (kupac_id));
